...
@implementation FZVideoEditingBundle
...
+ (NSBundle *)fz_bundle{
    ...
    if (bundle == nil) {
        ...
        bundle = [NSBundle bundleWithPath:[currentBundle pathForResource:@"FZVideoEditing" ofType:@"bundle"]];
        if (bundle == nil) {
            //mainBundle
            NSBundle *mainBundle = [NSBundle mainBundle];
            bundle = [NSBundle bundleWithPath:[mainBundle pathForResource:@"FZVideoEditing" ofType:@"bundle"]];
        }
    }
    return bundle;
}
